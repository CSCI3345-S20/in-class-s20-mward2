...
object TaskListInMemoryModel {
    private val users = mutable.Map[String, String]("Miranda" -> "Password")
    private val tasks = mutable.Map[String, List[String]]("Miranda" -> "Do homework", "Practice piano", "Code", "Maybe sleep")
